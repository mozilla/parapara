...
function initialize(Wall, wallData, design, $) {
  ...
  var AquariumWall = Wall.extend({
    getTemplateFields: function(character) {
      ...
      fields.frontCharTransform = "translate(0, " + yOfCharacter + ") scale(" +frontSize+ ")";
      fields.backCharTransform = "translate(0, " + yOfCharacter + ") scale("+backSize+ ") scale(-1, 1)";
      ...
      fields.rightEdge = 1200 + character.width;
