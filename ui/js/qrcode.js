...
//---------------------------------------------------------------------
// 2012-03-12 Brian Birtles, Mozilla Japan
//
//   The following URL appears to be a somewhat updated version of the original
//   referred to above:
//
...
var QRCode = QRCode ? QRCode : function() {
...
QRCode.prototype = {
  ...
  make : function() {
    ...
    if (this.typeNumber < 1 ){
      ...
      for (typeNumber = 1; typeNumber < 40; typeNumber++) {
        var rsBlocks =
          QRRSBlock.getRSBlocks(typeNumber, this.errorCorrectLevel);
  ...
  makeImpl : function(test, maskPattern) {
    ...
    if (this.dataCache == null) {
      this.dataCache =
        createData(this.typeNumber, this.errorCorrectLevel,
                          this.dataList);
    }
  ...
  getImage : function(cellSize, margin) {
    ...
    var imageData = this.getURIEncodedImage(size, size, function(x, y) {
  ...
  getURIEncodedImage : function(width, height, getPixel, alt) {
...
GifImage.prototype = {
  ...
  getLZWRaster : function(lzwMinCodeSize) {
    ...
    var bitOut = this.bitOutputStream(byteOut);
...
return QRCode; // Return QRCode object

}(); // End QRCode namespace
